...
MainScene3::MainScene3(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MainScene)
{
...
//计时器
void MainScene3::timerEvent(QTimerEvent *){

    ui->label->setText(QString::number(nowTime++));

}
void MainScene3::paintEvent(QPaintEvent*)
{
    //背景打印
...
//按键操作
void MainScene3::keyPressEvent(QKeyEvent  *event)
{
...
MainScene3::~MainScene3()
{
    delete [] Game;
    delete ui;
}

void MainScene3::on_actBack_triggered()
{
    this->close();
