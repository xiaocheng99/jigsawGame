    ...
    ui(new Ui::MainScene)
{
    ...
    for (int i = 0; i < NUM; i++)//为每个位置再申请NUM个内存空间
        Game[i] = new int[NUM];
...
void MainScene::on_actBack_triggered()
{
