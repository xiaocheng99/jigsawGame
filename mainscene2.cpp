...
MainScene2::MainScene2(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::MainScene)
{
...
//计时器
void MainScene2::timerEvent(QTimerEvent *){

    ui->label->setText(QString::number(nowTime++));

}
void MainScene2::paintEvent(QPaintEvent*)
{
    //背景打印
...
//按键操作
void MainScene2::keyPressEvent(QKeyEvent  *event)
{
...
void MainScene2::on_actBack_triggered()
{
    this->close();
